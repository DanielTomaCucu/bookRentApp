...
import { saveFeedabck } from '../fn/feedback/save-feedabck';
import { SaveFeedabck$Params } from '../fn/feedback/save-feedabck';
...
export class FeedbackService extends BaseService {
  ...
  /** Path part for operation `saveFeedabck()` */
  static readonly SaveFeedabckPath = '/feedback';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `saveFeedabck()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveFeedabck$Response(params: SaveFeedabck$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return saveFeedabck(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `saveFeedabck$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveFeedabck(params: SaveFeedabck$Params, context?: HttpContext): Observable<number> {
    return this.saveFeedabck$Response(params, context).pipe(
